...
const Stats = () => {
    return (
        <div className="px-4  mx-auto -w-full md:px-24 lg:px-8 lg:py-20 ">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="text-center">
            ...
            <h6 className="text-4xl font-bold text-deep-purple-accent-400">2000+</h6>
          ...
          <div className="text-center">
            ...
            <h6 className="text-4xl font-bold text-deep-purple-accent-400">12+</h6>
